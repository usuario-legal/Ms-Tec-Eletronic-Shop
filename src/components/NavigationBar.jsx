        ...
        {isMobile ? (
          <>
            ...
            <Typography variant="h6" component="div" sx={{ flexGrow: 1, minWidth: 0 }}>
              <Link to="/" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none' }}>
                <Box component="img" src="/logo.jpeg" alt="MS Tech Eletrónica" sx={{ height: 40, width: 'auto' }} />
              </Link>
            </Typography>
          </>
        ) : (
          <>
            ...
            <Typography variant="h6" component="div" sx={{ flexGrow: 1, display: 'flex', alignItems: 'center', gap: 1, minWidth: 0 }}>
              <Link to="/" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none' }}>
                <Box component="img" src="/logo.jpeg" alt="MS Tech Eletrónica" sx={{ height: 45, width: 'auto' }} />
              </Link>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.75, ml: 'auto' }}>
              ...
              {isLoggedIn ? (
                ...
                <>
                  ...
                  <Tooltip title="Criar conta" arrow>
        ...
        <DialogContent dividers>
          <Stack spacing={2}>
            ...
            {loading ? (
              ...
              <Typography variant="body2" color="text.secondary">
                Comece a digitar para explorar nosso catálogo.
              </Typography>
            )}
          </Stack>
        </DialogContent>
